...
public class DictionaryDaoImpl implements DictionaryInterface {
    ...
    private  static final String GET_STREET = ("SELECT street_code, street_name, street_area FROM" +
    ...
    public List<RegisterOffice> findRegisterOffice(String areaId) throws DaoException {
            ...
            try(Connection con = getConnection();
                ...
                ResultSet rs = stmt.executeQuery();
                while (rs.next()) {
                    RegisterOffice str = new RegisterOffice(rs.getInt("r_office_id"),
    ...
    @Override
    public List<CountryStruct> findArea(String areaId) throws DaoException {
        List<CountryStruct> result = new LinkedList<>();
        try(Connection con = getConnection();
            ...
            ResultSet rs = stmt.executeQuery();
            while (rs.next()) {
                CountryStruct str = new CountryStruct(
